...
export class ArrayEditor extends AbstractEditor {
    ...
    build() {
        if (!this.options.compact) {
            ...
            let isWideTab = this.options.tabWide === true;
            ...
            if (this.schema.format === 'tabs-top') {
                ...
                this.tabs_holder = this.theme.getTabHolder(title, isReversed, isWideTab);
                if (isTabCollapsed) {
                    this._createExpandButton();
                }
    ...
    getElementEditor(i) {
        ...
        if (!ret.title_controls) {
            ...
            if (this.array_controls_top && ret.title) {
                ret.title.appendChild(ret.array_controls);
            } else {
    ...
    showValidationErrors(errors) {
        ...
        this.rows.forEach(row => row.showValidationErrors(otherErrors));
    }
}
